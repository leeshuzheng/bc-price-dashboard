...
export const Header = () => {
  return (
    <header className="sticky w-full h-14 lg:h-16 bg-primary-100 flex items-center border-b border-white/20">
      <div className="container flex mx-auto px-5">
        <Link href="/" className="gap-1.5 flex items-center">
          ...
          <h1 className="text-2xl font-semibold text-white">
            price<span className="text-secondary-100">.dashboard</span>
          </h1>
        </Link>
      </div>
    </header>
